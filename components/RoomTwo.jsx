  ...
  const { nodes, materials } = useGLTF('/model/mo.glb')
    ...
    <group {...props} dispose={null}>
     ...
     <CuboidCollider args={[10,10,60]} position={[0,0,10]}/>
      ...
      <mesh geometry={nodes.Plane009.geometry}  position={[-222.463, 156.446, 259.231]} scale={[151.462, 76.548, 87.458]} ><meshBasicMaterial map={turf}/></mesh>
